...
// In your SignUp component - update the googleSignIn function
const googleSignIn = async () => {
  try {
    ...
    // FIX: Access result.data directly, not result.data.user
    dispatch(setUserData(result.data)); // Remove .user
