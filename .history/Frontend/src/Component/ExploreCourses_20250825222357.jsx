      ...
      <div className="w-[720px] max-w-[90%] lg:h-[300px] md:min-h-[300px] flex items-center justify-center lg:gap-[60px] gap-[50px] flex-wrap mb-[50px] lg:mb-[0px]">
        {courses.map((course, index) => {
          ...
          return (
            <motion.div 
              key={index} 
              className="w-[100px] h-[130px] font-light text-[13px] flex flex-col gap-3 text-center cursor-pointer"
            ...
            >
              <motion.div 
                className={`w-[px] h-[90px] bg-gradient-to-br ${course.color} rounded-lg flex items-center justify-center shadow-lg`}
                whileHover={{ 
              ...
              >
                ...
                >
                  <IconComponent className="w-[40px] h-[40px] text-white drop-shadow-lg" />
                </motion.div>
              </motion.div>
