      ...
      <div className="">
        <div className="">
          ...
          <div className="w-[100%] relative">
            ...
            {/* Main heading */}
            <span className="lg:text-[70px] absolute md:text-[40px] lg:top-[10%] top-[20%] w-[100%] flex items-center justify-center text-blue-700 font-bold text-[16px] px-2 text-center">
              Grow Your Skills to Advance Your Career
            </span>
            
            {/* Subheading */}
            <span className="lg:text-[70px] absolute md:text-[20px] lg:top-[18%] top-[25%] w-[100%] flex items-center justify-center text-blue-700 font-bold text-[16px] px-2 text-center">
              Your Career Path
            </span>
